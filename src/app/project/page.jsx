...
function Page() {
    return (
        <main className="overflow-hidden">
            ...
            <section className="relative mx-auto w-full px-4 pb-20 sm:px-6 md:px-10 lg:px-14">
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 justify-center items-stretch lg:items-center">
                    <div className="rounded-4xl border border-white/10 bg-white/6 p-6 sm:p-8 backdrop-blur-xl mt-10 lg:flex-1">
                        ...
                        <h3 className={`mt-4 text-[30px] leading-tight text-black ${anton.className}`}>
                            Warm highlights, cool contrast, and sharp hierarchy.
                        </h3>
                        <p className={`mt-4 max-w-2xl text-[15px] leading-relaxed text-black ${geologica.className}`}>
                            The page keeps the Scalix palette intact by using orange and sky-blue accents, then framing the work in elevated cards for a confident presentation.                        </p>
                    </div>
