    ...
    return (
        ...
        >
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="fixed bottom-6 left-6 z-50 w-14 h-14 rounded-full bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] shadow-lg shadow-purple-900/40 flex items-center justify-center hover:scale-110 hover:shadow-xl hover:shadow-purple-500/40 active:scale-95 transition-all duration-300 animate-bounce"
