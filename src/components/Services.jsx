                ...
                <div className="svc-anim opacity-0 -translate-x-10 transition-all duration-700 ease-out delay-100 w-full md:w-1/2">
                    ...
                    <div className="flex flex-col gap-5 mt-8">
                        {highlights.map((item, i) => (
                            ...
                            >
                                <div className="flex-shrink-0 h-10 w-10 rounded-lg bg-gradient-to-br from-[#ff6200] to-[#ff8a3d] text-white flex items-center justify-center shadow-md shadow-orange-200/40 transition-transform duration-300 group-hover:scale-110">
                                    {item.icon}
                                </div>
                                <div>
